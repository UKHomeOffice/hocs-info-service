...
Insert INTO stage_type (display_name, short_code, type, team_uuid, active, deadline)
VALUES ('Data Input', '111', 'DCU_MIN_DATA_INPUT', '44444444-2222-2222-2222-222222222222', true, 10),
       ('Markup', '112', 'DCU_MIN_MARKUP', '44444444-2222-2222-2222-222222222222', true, 1),
       ('Transfer Confirmation', '113', 'DCU_MIN_TRANSFER_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 3),
       ('No Reply Needed Confirmation', '114', 'DCU_MIN_NO_REPLY_NEEDED_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 0),
       ('Initial Draft', '115', 'DCU_MIN_INITIAL_DRAFT', '44444444-2222-2222-2222-222222222222', true, 10),
       ('QA Response', '116', 'DCU_MIN_QA_RESPONSE', '44444444-2222-2222-2222-222222222222', true, 0),
       ('Private Office Approval', '117', 'DCU_MIN_PRIVATE_OFFICE', '44444444-2222-2222-2222-222222222222', true, 0),
       ('Ministerial Sign off', '118', 'DCU_MIN_MINISTER_SIGN_OFF', '44444444-2222-2222-2222-222222222222', true, 0),
       ('Dispatch', '119', 'DCU_MIN_DISPATCH', '44444444-2222-2222-2222-222222222222', true, 20),
       ('Copy To Number 10', '11a', 'DCU_MIN_COPY_NUMBER_TEN', '44444444-2222-2222-2222-222222222222', true, 0),
       ('Data Input', '121', 'DCU_TRO_DATA_INPUT', '44444444-2222-2222-2222-222222222222', true, 5),
       ('Markup', '122', 'DCU_TRO_MARKUP', '44444444-2222-2222-2222-222222222222', true, 10),
       ('Transfer Confirmation', '123', 'DCU_TRO_TRANSFER_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 8),
       ('No Reply Needed Confirmation', '124', 'DCU_TRO_NO_REPLY_NEEDED_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 10),
       ('Initial Draft', '125', 'DCU_TRO_INITIAL_DRAFT', '33333333-3333-3333-3333-333333333333', true, 10),
       ('QA Response', '126', 'DCU_TRO_QA_RESPONSE', '33333333-3333-3333-3333-333333333333', true, 3),
       ('Dispatch', '127', 'DCU_TRO_DISPATCH', '33333333-3333-3333-3333-333333333333', true, 10),
       ('Copy to Number 10', '128', 'DCU_TRO_COPY_NUMBER_TEN', '33333333-3333-3333-3333-333333333333', true, 0),
       ('Data Input', '131', 'DCU_DTEN_DATA_INPUT', '33333333-3333-3333-3333-333333333333', true, 0),
       ('Markup', '132', 'DCU_DTEN_MARKUP', '33333333-3333-3333-3333-333333333333', true, 0),
       ('Transfer Confirmation', '133', 'DCU_DTEN_TRANSFER_CONFIRMATION', '33333333-3333-3333-3333-333333333333', true, 0),
       ('No Reply Needed Confirmation', '134', 'DCU_DTEN_NO_REPLY_NEEDED_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 10),
       ('Initial Draft', '135', 'DCU_DTEN_INITIAL_DRAFT', '11111111-1111-1111-1111-111111111111', true, 10),
       ('QA Response', '136', 'DCU_DTEN_QA_RESPONSE', '11111111-1111-1111-1111-111111111111', true, 10),
       ('Private Office', '137', 'DCU_DTEN_PRIVATE_OFFICE', '11111111-1111-1111-1111-111111111111', true, 0),
       ('Dispatch', '138', 'DCU_DTEN_DISPATCH', '11111111-1111-1111-1111-111111111111', true, 20),
       ('Copy To Number 10', '139', 'DCU_DTEN_COPY_NUMBER_TEN', '11111111-1111-1111-1111-111111111111', true, 10);
