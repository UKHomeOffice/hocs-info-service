...
Insert INTO stage_type (display_name, short_code, type, team_uuid, active, deadline, case_type)
VALUES ('Data Input', '111', 'DCU_MIN_DATA_INPUT', '44444444-2222-2222-2222-222222222222', true, 10, 'MIN'),
       ('Markup', '112', 'DCU_MIN_MARKUP', '33333333-3333-3333-3333-333333333333', true, 1, 'MIN'),
       ('Transfer Confirmation', '113', 'DCU_MIN_TRANSFER_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 3, 'MIN'),
       ('No Reply Needed Confirmation', '114', 'DCU_MIN_NO_REPLY_NEEDED_CONFIRMATION', '33333333-3333-3333-3333-333333333333', true, 0, 'MIN'),
       ('Initial Draft', '115', 'DCU_MIN_INITIAL_DRAFT', '44444444-2222-2222-2222-222222222222', true, 10, 'MIN'),
       ('QA Response', '116', 'DCU_MIN_QA_RESPONSE', '11111111-1111-1111-1111-111111111111', true, 0, 'MIN'),
       ('Private Office Approval', '117', 'DCU_MIN_PRIVATE_OFFICE', '44444444-2222-2222-2222-222222222222', true, 0, 'MIN'),
       ('Ministerial Sign off', '118', 'DCU_MIN_MINISTER_SIGN_OFF', '44444444-2222-2222-2222-222222222222', true, 0, 'MIN'),
       ('Dispatch', '119', 'DCU_MIN_DISPATCH', '44444444-2222-2222-2222-222222222222', true, 20, 'MIN'),
       ('Copy To Number 10', '11a', 'DCU_MIN_COPY_NUMBER_TEN', '44444444-2222-2222-2222-222222222222', true, 0, 'TRO'),
       ('Data Input', '121', 'DCU_TRO_DATA_INPUT', '44444444-2222-2222-2222-222222222222', true, 5,'TRO'),
       ('Markup', '122', 'DCU_TRO_MARKUP', '44444444-2222-2222-2222-222222222222', true, 10,'TRO'),
       ('Transfer Confirmation', '123', 'DCU_TRO_TRANSFER_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 8 ,'TRO'),
       ('No Reply Needed Confirmation', '124', 'DCU_TRO_NO_REPLY_NEEDED_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 10,'TRO'),
       ('Initial Draft', '125', 'DCU_TRO_INITIAL_DRAFT', '33333333-3333-3333-3333-333333333333', true, 10,'TRO'),
       ('QA Response', '126', 'DCU_TRO_QA_RESPONSE', '33333333-3333-3333-3333-333333333333', true, 3,'TRO'),
       ('Dispatch', '127', 'DCU_TRO_DISPATCH', '44444444-2222-2222-2222-222222222222', true, 10 ,'TRO'),
       ('Copy to Number 10', '128', 'DCU_TRO_COPY_NUMBER_TEN', '44444444-2222-2222-2222-222222222222', true, 0,'TRO'),
       ('Data Input', '131', 'DCU_DTEN_DATA_INPUT', '33333333-3333-3333-3333-333333333333', true, 0,'DTEN'),
       ('Markup', '132', 'DCU_DTEN_MARKUP', '33333333-3333-3333-3333-333333333333', true, 0,'DTEN'),
       ('Transfer Confirmation', '133', 'DCU_DTEN_TRANSFER_CONFIRMATION', '33333333-3333-3333-3333-333333333333', true, 0,'DTEN'),
       ('No Reply Needed Confirmation', '134', 'DCU_DTEN_NO_REPLY_NEEDED_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 10,'DTEN'),
       ('Initial Draft', '135', 'DCU_DTEN_INITIAL_DRAFT', '11111111-1111-1111-1111-111111111111', true, 10,'DTEN'),
       ('QA Response', '136', 'DCU_DTEN_QA_RESPONSE', '33333333-3333-3333-3333-333333333333', true, 10,'DTEN'),
       ('Private Office', '137', 'DCU_DTEN_PRIVATE_OFFICE', '11111111-1111-1111-1111-111111111111', true, 0,'DTEN'),
       ('Dispatch', '138', 'DCU_DTEN_DISPATCH', '33333333-3333-3333-3333-333333333333', true, 20,'DTEN'),
       ('Copy To Number 10', '139', 'DCU_DTEN_COPY_NUMBER_TEN', '11111111-1111-1111-1111-111111111111', true, 10,'DTEN');
