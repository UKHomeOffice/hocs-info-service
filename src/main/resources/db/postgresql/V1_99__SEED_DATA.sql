...
VALUES ('Data Input', '111', 'DCU_MIN_DATA_INPUT', '44444444-2222-2222-2222-222222222222', true, 10, 'MIN'),
       ('Markup', '112', 'DCU_MIN_MARKUP', '44444444-2222-2222-2222-222222222222', true, 1, 'MIN'),
       ('Transfer Confirmation', '113', 'DCU_MIN_TRANSFER_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 3, 'MIN'),
       ('No Reply Needed Confirmation', '114', 'DCU_MIN_NO_REPLY_NEEDED_CONFIRMATION', '44444444-2222-2222-2222-222222222222', true, 0, 'MIN'),
       ('Initial Draft', '115', 'DCU_MIN_INITIAL_DRAFT', '44444444-2222-2222-2222-222222222222', true, 10, 'MIN'),
       ('QA Response', '116', 'DCU_MIN_QA_RESPONSE', '44444444-2222-2222-2222-222222222222', true, 0, 'MIN'),
       ...
       ('Dispatch', '127', 'DCU_TRO_DISPATCH', '33333333-3333-3333-3333-333333333333', true, 10 ,'TRO'),
       ('Copy to Number 10', '128', 'DCU_TRO_COPY_NUMBER_TEN', '33333333-3333-3333-3333-333333333333', true, 0,'TRO'),
       ...
       ('QA Response', '136', 'DCU_DTEN_QA_RESPONSE', '11111111-1111-1111-1111-111111111111', true, 10,'DTEN'),
       ('Private Office', '137', 'DCU_DTEN_PRIVATE_OFFICE', '11111111-1111-1111-1111-111111111111', true, 0,'DTEN'),
       ('Dispatch', '138', 'DCU_DTEN_DISPATCH', '11111111-1111-1111-1111-111111111111', true, 20,'DTEN'),
