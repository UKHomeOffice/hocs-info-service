...
class EntityResource {
    ...
    @GetMapping(value = "/caseType/{caseType}/summary", produces = APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/entity/list/{name}", produces = APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/entity/{uuid}", produces = APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<EntityDto> getEntityBySimpleName(@PathVariable String simpleName) {
        Entity entity = entityService.getEntityBySimpleName(simpleName);
        return ResponseEntity.ok(EntityDto.from(entity));
    }

    @PostMapping(value = "/entity/list/{listName}", produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<String> createEntity(@PathVariable String listName, @RequestBody EntityDto entityDto, @RequestParam(name = "resort", defaultValue = "false") boolean resort) {
        entityService.createEntity(listName, entityDto, resort);
        return ResponseEntity.ok().build();
    }

    @PutMapping(value = "/entity/list/{listName}", produces = APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<String> deleteEntity(@PathVariable String listName, @RequestBody String entityUUID) {
