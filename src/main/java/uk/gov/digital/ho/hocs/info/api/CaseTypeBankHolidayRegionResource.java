...
public class CaseTypeBankHolidayRegionResource {
    ...
    @GetMapping(value = "/bankHolidayRegion/caseType/{caseType}", produces = APPLICATION_JSON_VALUE)
    public List<String> getBankHolidayRegionsByCaseType(@PathVariable String caseType) {
        return caseTypeBankHolidayRegionService.getBankHolidayRegionsByCaseType(caseType);
    }
}
