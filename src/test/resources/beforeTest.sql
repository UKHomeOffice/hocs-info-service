...
('39170e6b-591f-4ccd-b913-f9ad90d9f77a','dropdown','testDropdownActiveReadRestrict','Test Dropdown','["required"]',false,false,true,'{}','RESTRICTED_READ'),
('5e712bab-a52f-4dcc-95c7-332797406e53','dropdown','testDropdownNotActiveReadRestrict','Test Dropdown','["required"]',false,false,false,'{}','RESTRICTED_READ'),
('908f487c-cf73-4f54-a118-89ca16519320','dropdown','testDropdownActiveRead','Test Dropdown','["required"]',false,false,true,'{}','READ');
