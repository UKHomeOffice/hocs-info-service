...
public class GetAllTopicsResponseTest {
    ...
    public void from() {
        ...
        assertThat(
            getAllTopicsResponse.getParentTopicAndTopicDtos().get(0).getTopics().get(0).getDisplayName()).isEqualTo(
            "Topic1");
        assertThat(getAllTopicsResponse.getParentTopicAndTopicDtos().get(0).getTopics().get(0).getUuid()).isEqualTo(
            topic1Uuid);
    }
    ...
    public void fromTopicWithFilteredChildren() {
        ...
        var filteredTopics = topicSet.stream().filter(
            t -> Arrays.asList("Topic3", "Topic4").contains(t.getDisplayName())).collect(Collectors.toList());
        GetAllTopicsResponse getAllTopicsResponse = GetAllTopicsResponse.fromTopicWithFilteredChildren(parentTopics,
            filteredTopics);
        ...
        assertThat(
            ...
            "Topic3");
        assertThat(
            getAllTopicsResponse.getParentTopicAndTopicDtos().get(1).getTopics().get(0).getDisplayName()).isEqualTo(
            "Topic4");
        assertThat(getAllTopicsResponse.getParentTopicAndTopicDtos().get(0).getTopics().get(0).getUuid()).isEqualTo(
            topic3Uuid);
        assertThat(getAllTopicsResponse.getParentTopicAndTopicDtos().get(1).getTopics().get(0).getUuid()).isEqualTo(
            topic4Uuid);
